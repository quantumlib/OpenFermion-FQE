...
def antisymm_two_body(h2e: numpy.ndarray) -> numpy.ndarray:
    ...
    Args:
        h2e (numpy.ndarray) - input 2-body tensor
...
def antisymm_three_body(h3e: numpy.ndarray) -> numpy.ndarray:
    ...
    Args:
        h3e (numpy.ndarray) - input 3-body tensor
...
def antisymm_four_body(h4e: numpy.ndarray) -> numpy.ndarray:
    ...
    Args:
        h4e (numpy.ndarray) - input 4-body tensor
...
def nbody_matrix(ops: 'FermionOperator', norb: int) -> numpy.array:
