...
class CirqUitlsTest(unittest.TestCase):
    ...
    def test_x_y_z_mode_projection(self):
        """Find the projection of a wavefunction generated from a a linear
        combination of qubits.
        """
        n_qubits = 2
        qubits = cirq.LineQubit.range(n_qubits)
        test_cof = numpy.array([-0.20947377, 0.32054904, 0.92377985], dtype=numpy.complex64)
        ...
        self.assertListEqual(list(cof), list(test_cof))
