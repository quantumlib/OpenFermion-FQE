...
class UnitTest(unittest.TestCase):
    ...
    def test_configuration_key_union(self):
        ...
        self.assertSetEqual(testset, set(util.configuration_key_union(configs0, configs1)))
    ...
    def test_configuration_key_intersection_none(self):
        ...
        """
        self.assertListEqual([], util.configuration_key_intersection([(2, 0)], [(2, 2)]))
    ...
    def test_configuration_key_intersection(self):
        ...
        self.assertListEqual([(3, 1)], util.configuration_key_intersection(configs0, configs1))
    ...
    def test_qubit_config_sector(self):
        ...
        zero = 0
        one = 1
        lowstate = [zero, zero, one, zero, zero, zero, zero, zero, zero, zero,
                    zero, zero, zero, zero, zero, zero]
        highstate = [zero, zero, zero, zero, zero, zero, zero, zero, one, zero,
                     zero, zero, zero, zero, zero, zero]
        ref = [numpy.array(lowstate, dtype=numpy.int),
    ...
    def test_qubit_vacuum(self):
        ...
        """
        _gs = numpy.array([1. + .0j, 0. + .0j, 0. + .0j, 0. + .0j], dtype=numpy.complex64)
