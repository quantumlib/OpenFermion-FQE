...
def test_evolve_individual_nbody_nontrivial(c_or_python):
    ...
    evolved_data = data.evolve_individual_nbody_nontrivial(time, coeff,
                                                           daga, undaga,
                                                           dagb, undagb)

    ref_coeff = numpy.array([[0.33333333+0.j, 0.33333333+0.j,
                              0.33333333+0.j],
                             [0.33333329-0.00016667j, 0.33333333+0.j,
                              0.33333333+0.j],
                             [0.33333329-0.00016667j, 0.33333333+0.j,
                              0.33333333+0.j ]])
...
def test_apply_spatial1_onecolumn(c_or_python):
    ...
    h1 = numpy.asarray([[1.0 + 0.j, 0. + 0.j, 0.0 + 0.j],
    ...
    assert numpy.allclose(
            work.coeff,
            numpy.asarray([[ 2.+0.j,  1.+0.j,  2.+0.j],
                          [ 2.+0.j,  1.+0.j,  2.+0.j],
                          [ 0.+0.j, -1.+0.j,  0.+0.j]],
                          dtype=numpy.complex128))
...
def test_apply_3body_only(c_or_python, fixture_for_1234):
    ...
    ref = numpy.array([[ 1.77037169+1.78556681j,  2.02983483+3.01074068j,
                       ...
                       [-6.8296471 -0.28793326j, -7.60243083-0.18066159j,
                        -11.39744174-0.31132574j,-14.39599744-0.14089318j]])
    assert numpy.allclose(ref, out.coeff)
