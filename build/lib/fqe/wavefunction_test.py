...
class WavefunctionTest(unittest.TestCase):
    ...
    def test_add_config_behavior(self):
        ...
        wfn = wavefunction.Wavefunction([[2, 0, 4]])
        config = wfn.configs
        wfn.add_config(-1, -1, 10)
        self.assertTrue(config == wfn.configs)
        wfn.add_config(2, 0, 4)
        self.assertTrue(config == wfn.configs)
        self.assertRaises(ValueError, wfn.add_config, 2, 0, 4, 0)
    ...
    def test__add__equal_config_wavefunctions(self):
        ...
        self.assertTrue(numpy.allclose(wfn3.get_coeff((2, 2), vec=[0]), ref))
    ...
    def test__add__different_config_wavefunctions(self):
        ...
        self.assertTrue(numpy.allclose(wfn3.get_coeff((2, 2), vec=[0]), ref2_2))
        self.assertTrue(numpy.allclose(wfn3.get_coeff((2, 0), vec=[0]), ref2_0))
    ...
    def test__mul__wavefunction(self):
        ...
        self.assertTrue(numpy.allclose(wfn.get_coeff((2, 0), vec=[0]), ref))
    ...
    def test_wavefunction_config_access(self):
        ...
        ref[2, 0] = .333 + .54j
        self.assertTrue(numpy.allclose(test.get_coeff((4, 2), vec=[0]), ref))
